...
export default function AddClinicPage() {
  ...
  return (
    <div className="mx-auto w-full space-y-6 rounded-[12px] border-2 border-[#E4EBF0] p-4 md:p-6 lg:p-8 mb-8  border-b  bg-white px-6 py-4">
      {/* Clinic Information Section */}
      <div className="overflow-hidden rounded-lg">
        <div className="">
          <h2 className="md:text-2xl text-xl font-medium text-[#1B1F3A]">
            Clinic Information
          </h2>
        </div>
      ...
      <div className="flex flex-wrap justify-center gap-4 pt-4">
        ...
        <button
          ...
          className="min-w-[150px]  disabled:cursor-not-allowed 
             cursor-pointer   px-6 py-2 bg-[#225A7F] text-white rounded-[4px] hover:bg-[#1b4a68] disabled:opacity-70  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
        >
          {isSubmitting ? (
            <>
