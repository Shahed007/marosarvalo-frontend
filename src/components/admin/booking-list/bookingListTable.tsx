...
export const BookingTable = () => {
  ...
  // Handle Remove (just logs for now — you can add deletion logic)
  ...
  const modalContent = (
    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.userName}</Text>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.subject}</Text>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.message}</Text>
      </div>
    </div>
  );
