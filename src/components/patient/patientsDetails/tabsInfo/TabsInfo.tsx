      ...
      children: (
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            <Title level={3} color="#0B121B">Bonds:</Title>
            <div className="overflow-x-auto">
        ...
        <Card className="space-y-6">
          <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 flex-wrap">
              <Button icon={<IoMdDownload />} className="w-full sm:w-auto">
                Download Document
              </Button>
              <Button icon={<IoMdDownload />} className="w-full sm:w-auto">
                Download Document
        ...
        <Card className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base">
              45M, HTN/DM2. Penicillin allergy. UL6 sensitivity + gum bleeding.
              Last cleaning Jun/23.
            </p>
          </div>
          <div>
            ...
            <p className="text-sm sm:text-base">
              ...
              (cleaning). Complaints: UL6 sensitivity, occasional gum bleeding.
              Poor flossing. FH: HTN (father), DM2 (mother).
            </p>
          </div>
        </Card>
      ),
