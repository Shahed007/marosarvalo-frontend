...
export default function SettingUnavailabilityPage() {
  // Mock unavailability data
  const unavailabilityData = [
    {
      key: "1",
      userNameId: "Emily Carter\n(ID: 152451)",
      date: "12 April, 2025",
      day: "01 D",
      reason: "New Year",
    },
    ...
    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span style={{ fontWeight: 500 }}>User Name & ID</span>
        </div>
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.userNameId}</Text>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.date}</Text>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.day}</Text>
        ...
        <Text style={{ fontSize: "14px", color: "#1E293B" }}>{selectedRecord?.reason}</Text>
      </div>
    </div>
  );
